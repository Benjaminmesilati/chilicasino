...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className="flex w-full p-2.5 bg-[#EC8760] fixed top-0 left-0 z-50 backdrop-blur-[20px]">
        <div className="flex w-full items-center justify-between relative mx-auto  md:max-w-6xl">
        <div className="flex gap-5 items-center">
          <Link href="/" passHref>
            <div className="flex items-center h-9 m-0 cursor-pointer">
              <img alt="Gamba logo" src="/logo.png" className="h-full rotate-45" />
              <h1 className="text-xl bold">Chili</h1>
            </div>
          </Link>
        </div>
